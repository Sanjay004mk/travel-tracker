        ...
        <div>
          ...
          <div className="mb-12 grid gap-x-6 gap-y-10 md:grid-cols-2 xl:grid-cols-4">
            {trips.map((trip, index) => (
              <div
                key={index}
                onClick={() => navigate("/dashboard/trip/" + trip.tripCode)}
              >
                <TripCard
                  title={trip.location}
                  color="white"
            ...
            <div onClick={() => enableTripForm(2)}>
              <TripCard
                ...
                color="white"
                value="Start"
                icon={<PlusCircleIcon className="text-gray-950 h-12 w-12" />}
                footer={
                  <Typography className="text-sm font-normal text-blue-gray-600">
                    Start a new trip.
                  </Typography>
          ...
          <div>
            ...
            <div className="mb-4 grid gap-x-6 gap-y-10 md:grid-cols-2 xl:grid-cols-4">
          ...
          <Card className="max-w-60 mb-4">
            <CardBody className="max-w-60">
              <div className="mb-6 flex max-w-xl flex-col items-start gap-2">
                <Input
                  label="Trip code"
                  value={reqTripCode}
                ...
                <Button
                  onClick={async () => {
                    if (!reqTripCode.trim().length === 0) return;
                    try {
