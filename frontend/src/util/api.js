...
export const inviteToTrip = (tripCode, email) => API.post(`/trip/invite/${tripCode}`, { email });
export const addToTrip = (tripCode, userId) => API.post(`/trip/add/${tripCode}`, { userId });
export const removeFromTrip = (tripCode, userId) => API.post(`/trip/remove/${tripCode}`, { userId });
